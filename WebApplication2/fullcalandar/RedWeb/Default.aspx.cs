...
public partial class _Default : System.Web.UI.Page
{
    ...
    public static string UpdateEvent(CalendarEvent cevent)
    {
        ...
        if (idList != null && idList.Contains(cevent.id))
        {
            ...
            //}
            if (CheckAlphaNumeric(cevent.jourinfo.ToString()))
            {
                  EventDAO.updateEvent(cevent.id,"","");
                return "updated event with id:" + cevent.id + " update title to: " + " "+ " update description to: " + "";
            }
        }

        return "unable to update event with id:" + cevent.id + " title : " + string.Empty +
    ...
    public static int addEvent(ImproperCalendarEvent improperEvent)
    {
        ...
        if (CheckAlphaNumeric(cevent.jourinfo.ToString()))// && CheckAlphaNumeric(cevent.description))
        {

    ...
    <div id="addDialog" style="font: 70% 'Trebuchet MS', sans-serif; margin: 50px;" title="Add Event">
        <table cellpadding="0" class="style1">
            ...
            <tr>
                ...
                <td class="alignLeft">
                    <asp:DropDownList ID="workType" runat="server" 
                        DataSourceID="SqlDataSource1" DataTextField="TYPE" DataValueField="NOMBRE">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:DbConnection %>" 
                        SelectCommand="SELECT [TYPE], [NOMBRE] FROM [T_TYPEJOUR] ORDER BY [ID]">
                    </asp:SqlDataSource>
                </td>
            </tr>

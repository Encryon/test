...
public class EventDAO
{
    ...
    private static string connectionString = "Data Source=PEUWUL17732\\SQLEXPRESS;Initial Catalog=FullCalendar;Integrated Security=True";
    ...
    public static List<CalendarEvent> getEvents(DateTime start, DateTime end)
    {
        ...
        using (con)
        {
            ...
            while (reader.Read())
            {
                ...
                cevent.description = (string)reader["workType"];
